...
### Tramo 2 — Dolores
2. De todo lo que implica manejar la tienda, ¿qué parte te quita más tiempo o te genera más dolores de cabeza?
...
4. Describe qué haces exactamente cuando llega mercancía nueva a la tienda, desde que la recibes hasta que queda lista para vender.
...
### Tramo 4 — Excepciones
6. Cuéntame de una devolución reciente. ¿Qué hiciste con el producto y con el registro de esa venta?
7. Cuéntame de una vez que hayas vendido algo que, sin saberlo, ya no tenías en esa talla o color. ¿Qué pasó cuando te diste cuenta?

### Tramo 5 — Verificación de supuestos
Estas preguntas salen directo de las cosas que todavía tenía como "supuesto sin confirmar" en la especificación.
...
Repasando las 7 preguntas de arriba: ninguna se contesta con un simple sí/no y ninguna sugiere la respuesta, así que las dejé tal cual.
